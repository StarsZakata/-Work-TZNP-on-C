...
public:
    ...
    virtual void process(){
            ...
            if(!TypeDef){
                Str.getPhsA().setvalue(SeqA->getS3().getCVal().getMag().getvalue() > StrVal.getSetVal().getvalue());
                Str.getPhsB().setvalue(SeqA->getS3().getCVal().getMag().getvalue() > StrVal.getSetVal().getvalue());
                Str.getPhsC().setvalue(SeqA->getS3().getCVal().getMag().getvalue() > StrVal.getSetVal().getvalue());
            }
            ...
            if (DirMod.getSetVal().getvalue() == 1) {
                if ((dir->getPhsA().getvalue())) {
                    timeA = 0;
                }
                if (dir->getPhsB().getvalue()) {
                    timeB = 0;
                }
                if (dir->getPhsC().getvalue()) {
                    timeC = 0;
                }
            }
