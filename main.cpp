...
int main() {
    ...
    ptoc.setSeqA(&msqi.getSeqA());

    ptoc.getStrVal().getSetVal().setvalue((float) 1000);
    ptoc.getOpDITmms().getSetVal().setvalue(200);

     ptoc.getDirMod().getSetVal().setvalue(1); //1-directly 2-back

     ptoc.setDir(&rdir.getDir());
